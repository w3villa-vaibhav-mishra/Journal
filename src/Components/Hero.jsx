    ...
    <>
      <div className="flex w-full justify-center bg-white py-4">
        <div className="   lg:flex  items-center max-w-[1600px] w-full lg:h-[600px] box-border">
          <div className=' w-full h-2/3 lg: lg:w-2/3 lg:h-full pr-4 rounded-xl flex  justify-center items-center lg:items-start  '>
            <div className=' w-2/4 lg:w-1/3 h-full flex flex-col justify-center p-2 rounded-l-md overflow-hidden bg-stone-950 gap-4'>
          ...
          <div className='h-1/3 w-full lg: lg:w-1/3 lg:h-full  rounded-xl flex lg:flex-col justify-center items-center  gap-4'>
