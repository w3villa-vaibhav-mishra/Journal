    ...
    <>
        ...
        <div className="flex w-full] justify-center ">
            <div className="flex flex-col flex-wrap justify-start max-w-[1600px] w-full my-2  ">
                <div className='flex justify-items-start  sm:justify-center md:text-[30px] font-bold'>Why buy from us?</div>
                ...
                <div className="flex justify-center gap-3 mt-2 text-slate-600">
