    ...
    <>
        ...
        <div className="flex w-full justify-center bg-slate-400">
            <div className="flex flex-col flex-wrap justify-start max-w-[1600px]    ">
                <div className='flex justify-items-start  sm:justify-center md:text-[20px]'>Featured Category</div>
                <div className='sm:flex justify-center'><div className=' w-20 sm:flex justify-center border-t-2  border-orange-500  '></div>
                </div>
                <div className='text-left pt-4 text-[13px] sm:text-center md:text-[15px] lg:text-[20px] lg:p-8'>
